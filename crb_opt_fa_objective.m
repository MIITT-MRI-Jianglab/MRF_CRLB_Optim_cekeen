function objective = crb_opt_fa_objective(x)
    params.niter = length(x);
    params.niso = 250;
    ...
    % RF Phase
    params.ph = zeros(1,params.niter);
    ...
    objective = crbmat(1,1) + crbmat(2,2);% + mean(msig);
end